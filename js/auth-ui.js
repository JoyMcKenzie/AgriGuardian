...
function showStep(step) {
  ...
  if (step === 'invite') {
    ...
    if (hintEl) hintEl.innerHTML = t('inviteDemoHint').replace('987654', '<strong style="background:#FFFFFF;padding:2px 8px;border-radius:6px;border:1px solid #E2EFE8;letter-spacing:2px">987654</strong>');
  }
  if (step === 'code') {
